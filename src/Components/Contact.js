        ...
        <form ref={form} onSubmit={sendEmail}>
          <div class="row">
            ...
            <div className="col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6 right">
              ...
              <p><img style={{width:"20px", height:"20px"}} src={link}/><a href="https://github.com/lokesh000000" target="_blank"><img className="link" src={github}/></a></p>
              <p><i class="fa fa-envelope bounce-1" aria-hidden="true"></i>-lokeshkanna330@gmail.com</p>
              <p><i class="fa fa-phone" aria-hidden="true"></i>  +91 8667328581</p>
